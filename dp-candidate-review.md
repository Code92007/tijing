...
- 同一道题可以进入多个子分组；“DP 优化、松弛、分治优化、斜率优化”等只作为标签，不新开分组。
...
其中 `N16 HDU4055 Number String` 按你的要求放在线性 DP，并标注 `排列 DP / 插入法 / 前缀和优化 / 波浪排列`。资料中的“置置置换”与它是同类插入模型，只保留一条主记录并在备注中互相指向。
...
| N06 | [ECNA 2023 B - B Road Band](https://codeforces.com/gym/104757/problem/B) | 线性 DP；分段、决策单调性、分治优化 | 实战 | 是分治优化的完整应用题；优化只作标签。 | [CSDN](https://blog.csdn.net/Code92007/article/details/134636520) |
...
| N13 | [ABC134 F - Permutation Oddness](https://atcoder.jp/contests/abc134/tasks/abc134_f) | 线性 DP；排列 DP、插入法、贡献 | **经典** | 插入元素并维护贡献，是排列类 DP 的标准范例。 | [CSDN](https://blog.csdn.net/Code92007/article/details/113834827) |
...
| N16 | [HDU4055 - Number String](https://acm.hdu.edu.cn/showproblem.php?pid=4055) | 线性 DP；**排列 DP、插入法、前缀和优化、波浪排列** | **经典** | 插入 trick 独特且可迁移；“置置置换”作为同构题备注，不重复建题。 | [CSDN](https://blog.csdn.net/Code92007/article/details/106976509) |
...
| N45 | [CF1101F - Trucks and Cities](https://codeforces.com/contest/1101/problem/F) | 线性 DP；分段、分治优化、二分答案 | 实战 | 优化链条完整，但更适合高阶训练而非基础经典。 | [CSDN](https://blog.csdn.net/Code92007/article/details/86500021) |
...
| N59 | [2019 Nowcoder Multi-University 10 J - Wood Processing](https://ac.nowcoder.com/acm/contest/890/J) | 线性 DP；分组、斜率优化 | 实战 | 是斜率优化在分段 DP 中的正规赛题应用。 | [CSDN](https://blog.csdn.net/Code92007/article/details/108356003) |
| N60 | [CF868F - Yet Another Minimization Problem](https://codeforces.com/contest/868/problem/F) | 线性 DP；分段、分治优化、双指针维护代价 | **经典** | 分治优化 DP 的代表题，模型和实现都具有模板价值。 | [CSDN](https://blog.csdn.net/Code92007/article/details/108212280) |
...
| N65 | [CF2038D - Divide OR Conquer](https://codeforces.com/contest/2038/problem/D) | 线性 DP；乱序 DP、二维偏序 | 实战 | 遍历顺序本身就是难点，适合训练偏序状态的组织方式。 | [知乎](https://zhuanlan.zhihu.com/p/2060737935792776329) |
...
| N70 | [洛谷 P5999 / CEOI 2016 - kangaroo](https://www.luogu.com.cn/problem/P5999) | 线性 DP；排列 DP、插入法 | **经典** | 与 N13、N16 形成清晰的排列插入 DP 小专题。 | [知乎](https://zhuanlan.zhihu.com/p/2050743938642981229) |
...
| N73 | [CF1715E - Long Way Home](https://codeforces.com/contest/1715/problem/E) | 线性 DP；最短路分层、斜率优化 CHT | **经典** | DP、最短路与 CHT 的衔接很有代表性。 | [知乎](https://zhuanlan.zhihu.com/p/2006899847589011664) |
...
| N24 | [CF1734F - Zeros and Ones](https://codeforces.com/contest/1734/problem/F) | 数位 DP；Thue-Morse、进位 | 实战 | 利用序列自相似性做数位递推，辨识度高。 | [CSDN](https://blog.csdn.net/Code92007/article/details/127040401) |
| N25 | [CF1487F - Ones](https://codeforces.com/contest/1487/problem/F) | 数位 DP；高位到低位、借位、延迟贡献 | 实战 | 非典型数位状态，对进借位建模训练很好。 | [CSDN](https://blog.csdn.net/Code92007/article/details/113829187) |
...
- DP 优化题不另设分类：主分组照常放，标签写明 `松弛 / 分治优化 / 斜率优化 / 单调栈优化 / 前后缀优化`。
